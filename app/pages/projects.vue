...
const projects = [
  ...
  },
  {
    title: 'Koda',
    category: 'perso' as Category,
    description: 'KODA vous aide à rester concentré, gérer vos tâches efficacement et développer des habitudes de productivité durables grâce a un tableau Kanban, un timer Pomodoro, statistiques détaillées et des objectifs quotidiens.',
